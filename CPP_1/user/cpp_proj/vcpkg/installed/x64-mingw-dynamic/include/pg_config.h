...
// #define CONFIGURE_ARGS " '--build=x86_64-pc-mingw32' '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' 'gl_cv_double_slash_root=yes' 'ac_cv_func_memmove=yes' '--disable-silent-rules' '--verbose' '--enable-shared' '--disable-static' '--prefix=/C/src/vcpkg/installed/x64-mingw-dynamic' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'build_alias=x86_64-pc-mingw32' 'CC=C:/Qt/Tools/mingw1310_64/bin/x86_64-w64-mingw32-gcc.exe' 'CFLAGS=-O3' 'LDFLAGS=-LC:/src/vcpkg/installed/x64-mingw-dynamic/lib' 'LIBS=-lkernel32 -luser32 -lgdi32 -lwinspool -lshell32 -lole32 -loleaut32 -Wl,-Bstatic,-luuid,-Bdynamic -lcomdlg32 -ladvapi32' 'CPPFLAGS=-DNDEBUG' 'CXX=C:/Qt/Tools/mingw1310_64/bin/x86_64-w64-mingw32-g++.exe' 'CXXFLAGS=-O3' 'CPP=C:/Qt/Tools/mingw1310_64/bin/x86_64-w64-mingw32-gcc.exe -E' 'PKG_CONFIG=C:/src/vcpkg/downloads/tools/msys2/fdbea3694fb5c0d4/mingw64/bin/pkg-config.exe' 'PKG_CONFIG_PATH=C:/src/vcpkg/packages/libpq_x64-mingw-dynamic/lib/pkgconfig;C:/src/vcpkg/packages/libpq_x64-mingw-dynamic/share/pkgconfig;C:/src/vcpkg/installed/x64-mingw-dynamic/lib/pkgconfig;C:/src/vcpkg/installed/x64-mingw-dynamic/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on x86_64-pc-mingw32, compiled by x86_64-w64-mingw32-gcc.exe (x86_64-posix-seh-rev1, Built by MinGW-Builds project) 13.1.0, 64-bit"
