...
/** \brief Represents a <a HREF="http://www.jsoncpp.org">JSON</a> value.
 *
...
public:
  ...
  /// Requires that this value holds an array or jsoncpp object, with at least one element.
  ...
  /// Requires that value holds an array or jsoncpp object, with at least one element.
